...
/*
        dialogBtn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                dlg.setTitle("개인 정보 동의");
                dlg.setMessage("개인 정보 동의에 확인하십니까?");
                dlg.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(LoginActivity.this, "확인을 누르셨습니다.", Toast.LENGTH_SHORT).show();
                    }
                });
                dlg.setNegativeButton("아니요", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(getApplicationContext(),"아니요를 누르셨습니다", Toast.LENGTH_LONG).show();
                        finish();
                    }
                });
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (success) {//회원등록 성공한 경우
                                ...
                                String userName = PreferenceManager.getString(getBaseContext(), userID);
